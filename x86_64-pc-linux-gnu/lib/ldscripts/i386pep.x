...
SEARCH_DIR("/root/yukiclang/build/install/x86_64-pep/lib"); SEARCH_DIR("/root/yukiclang/build/install/lib"); SEARCH_DIR("/usr/local/lib"); SEARCH_DIR("/lib"); SEARCH_DIR("/usr/lib");
SECTIONS
{
